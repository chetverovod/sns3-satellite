...
#include "satellite-orbiter-net-device-dvb.h"
...
TypeId
SatOrbiterNetDeviceDvb::GetTypeId(void)
{
    static TypeId tid = TypeId("ns3::SatOrbiterNetDeviceDvb")
                            .SetParent<SatOrbiterNetDevice>()
                            .AddConstructor<SatOrbiterNetDeviceDvb>();
    return tid;
}

SatOrbiterNetDeviceDvb::SatOrbiterNetDeviceDvb()
    : SatOrbiterNetDevice()
{
...
void
SatOrbiterNetDeviceDvb::ReceivePacketUser(Ptr<Packet> packet, const Address& userAddress)
{
...
void
SatOrbiterNetDeviceDvb::ReceivePacketFeeder(Ptr<Packet> packet, const Address& feederAddress)
{
    NS_LOG_FUNCTION(this << packet);
    NS_LOG_INFO("Receiving a packet: " << packet->GetUid());
...
void
SatOrbiterNetDeviceDvb::ReceiveFromIsl(Ptr<Packet> packet, Mac48Address destination)
{
...
void
SatOrbiterNetDeviceDvb::ConnectUt(Mac48Address utAddress, uint32_t beamId)
{
...
void
SatOrbiterNetDeviceDvb::DisconnectUt(Mac48Address utAddress, uint32_t beamId)
{
    NS_LOG_FUNCTION(this << utAddress << beamId);
