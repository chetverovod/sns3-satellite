...
#ifndef LORAWAN_ORBITER_MAC_GATEWAY_H
#define LORAWAN_ORBITER_MAC_GATEWAY_H
...
class LorawanOrbiterMacGateway : public LorawanMacGateway
{
  public:
    ...
    LorawanOrbiterMacGateway();
    LorawanOrbiterMacGateway(uint32_t satId, uint32_t beamId);
    virtual ~LorawanOrbiterMacGateway();
