...
SatNetDevice::GetTypeId(void)
{
    static TypeId tid =
        TypeId("ns3::SatNetDevice")
            ...
            .AddAttribute("SatMac",
                          "The Satellite MAC layer attached to this device.",
                          PointerValue(),
                          MakePointerAccessor(&SatNetDevice::GetMac, &SatNetDevice::SetMac),
                          MakePointerChecker<SatMac>())
            .AddAttribute("SatPhy",
                          "The Satellite Phy layer attached to this device.",
                          PointerValue(),
                          MakePointerAccessor(&SatNetDevice::GetPhy, &SatNetDevice::SetPhy),
                          MakePointerChecker<SatPhy>())
            .AddAttribute("SatLlc",
                          "The Satellite Llc layer attached to this device.",
                          PointerValue(),
                          MakePointerAccessor(&SatNetDevice::GetLlc, &SatNetDevice::SetLlc),
...
bool
SatNetDevice::SendFrom(Ptr<Packet> packet,
